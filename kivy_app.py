...
#         self.submit_btn = Button(text="Register")
...
#             conn = sqlite3.connect(DB)
#             c = conn.cursor()
#             c.execute("INSERT INTO patients (name, age, gender, date, synced) VALUES (?, ?, ?, ?, ?)",
#                       (name, int(age), gender, date, 0))
#             conn.commit()
#             conn.close()
#             self.status.text = "✅ Patient saved offline!"
